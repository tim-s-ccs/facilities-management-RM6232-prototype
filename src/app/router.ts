...
import procurementBuildings from './routes/facilitiesManagement/procurementBuildings'
...
const routes: Array<[string, Router]> = [
  ...
  ['/facilities-management/RM6232/procurement-buildings', procurementBuildings],
