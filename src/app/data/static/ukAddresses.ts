...
const ukAddresses: Array<UKAddressRow> = [
  ...
  },
  {
    ...
    address_line_2: '',
    address_postcode: 'B2 4BH',
    address_town: 'Birmingham'
  }
]

export default ukAddresses